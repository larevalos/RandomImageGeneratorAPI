...
namespace EvaluationAPI.Models
{
    public class PagedCollection<T> : Collection<T>
    {
        ...
        public int? Offset { get; set; } //offset that we're currently at from the beginning of the collection

        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public int? Limit { get; set; } //how many items represents per pages
